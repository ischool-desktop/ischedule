...
//                //取得所有選取教師系統編號
//                case "Teacher":
//                    foreach (dynamic SelectItem in (MainFormBL MotehrWindow.Instance.frmWho.Content as usrWhoList).fgWhoList.SelectedItems)
//                    {
//                        string WhoID = SelectItem.WhoID;

//                        if (!AssocIDs.Contains(WhoID))
//                            AssocIDs.Add(WhoID);
//                    }
//                    break;
//                //取得所有選取班級系統編號
//                case "Class":
//                    foreach (dynamic SelectItem in (MotehrWindow.Instance.frmWhom.Content as usrWhomList).fgWhomList.SelectedItems)
//                    {
//                        string WhomID = SelectItem.WhomID;
//                        if (!AssocIDs.Contains(WhomID))
//                            AssocIDs.Add(WhomID);
//                    }
//                    break;
//                //取得所有選取場地系統編號
//                case "Classroom":
//                    foreach (dynamic SelectItem in (MotehrWindow.Instance.frmWhere.Content as usrWhereList).fgWhereList.SelectedItems)
//                    {
//                        string WhereID = SelectItem.WhereID;
//                        if (!AssocIDs.Contains(WhereID))
//                            AssocIDs.Add(WhereID);
//                    }
//                    break;
//            }
//            #endregion
...
//                chkTeacherBusyDesc.Checked = chkMergeTimeTable.Checked;
//            };
//            #endregion
...
//                switch (MotehrWindow.SelectedType)
//                {
//                    case Constants.lvWho:
//                        schLocal.Whos[x].UseAppointments(0);    //預設使用第一個行事曆
//                        apsCur = schLocal.Whos[x].Appointments; //取得資源已被排定的約會
//                        LPViewName = schLocal.Whos[x].Name;
//                        LPViewType = "教師";
//                        LPViewClassTeacherName = string.Empty;
//                        BasicLength = Int.GetString(schLocal.Whos[x].BasicLength);
//                        ExtraLength = Int.GetString(schLocal.Whos[x].ExtraLength);
//                        CounselingLength = Int.GetString(schLocal.Whos[x].CounselingLength);
//                        Comment = schLocal.Whos[x].Comment;
//                        break;
//                    case Constants.lvWhom:
//                        apsCur = schLocal.Whoms[x].Appointments;
//                        //if (chkUpgradeClassName.IsChecked == true)
//                        //    LPViewName = schLocal.Whoms[x].GetUpgradeClassName();
//                        //else
//                        LPViewName = schLocal.Whoms[x].Name;
//                        LPViewType = "班級";
//                        LPViewClassTeacherName = schLocal.Whoms[x].TeacherName;
//                        break;
//                    case Constants.lvWhere:
//                        schLocal.Wheres[x].UseAppointments(0); //預設使用第一個行事曆
//                        apsCur = schLocal.Wheres[x].Appointments;
//                        LPViewName = schLocal.Wheres[x].Name;
//                        LPViewType = "場地";
//                        LPViewClassTeacherName = string.Empty;
//                        break;
//                }
